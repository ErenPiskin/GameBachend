...
public class KPSPublicSoapProxy implements tr.gov.nvi.tckimlik.WS.KPSPublicSoap {
  ...
  public boolean TCKimlikNoDogrula(String long1, java.lang.String ad, java.lang.String soyad, int dogumYili) throws java.rmi.RemoteException{
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
    return kPSPublicSoap.TCKimlikNoDogrula(long1, ad, soyad, dogumYili);
  }

public boolean TCKimlikNoDogrula(Long valueOf, String playerFirstName, String playerLastName, int year) {
	// TODO Auto-generated method stub
	return false;
}

public boolean TCKimlikNoDogrula(long parseLong, String playerFirstName, String playerLastName, LocalDate birthOfDate) {
	// TODO Auto-generated method stub
	return false;
}
